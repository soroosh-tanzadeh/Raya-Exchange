...
(function($) {
	...
	function commarize(data){
		...
		formats = [' ŲŖŲ±ŪŁ„ŪŁŁ†',' Ł…ŪŁ„ŪŲ§Ų±ŲÆ',' Ł…ŪŁ„ŪŁŁ†',' Ł‡Ų²Ų§Ų±'];
		...
		$.fn.mcwpTable = function(options) {
			...
			var table = $(this).DataTable({
				...
				language: {
					processing: '',
					paginate: {
						next: 'ŲØŲ¹ŲÆŪ <span class="micon-arrow-circle-o-right"></span>',
						previous: '<span class="micon-arrow-circle-o-left"></span> Ł‚ŲØŁ„Ū'  
					}
				}
			});
