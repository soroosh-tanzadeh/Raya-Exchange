                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav line-tabs nav-justified line-tabs-2x line-tabs-solid mb-5">
                            ...
                            <li class="nav-item"><a class="dcurrency-select nav-link text-center" data-toggle="tab" href="#tab-2" data-coin="litecoin" data-price="{{ $coins[2]->price_in_toman_int }}"><i class="cc LTC-alt font-26 text-secondary mb-2"></i></a></li>
                            <li class="nav-item"><a class="dcurrency-select nav-link text-center" data-toggle="tab" href="#tab-2" data-coin="ripple" data-price="{{ $coins[3]->price_in_toman_int }}"><i class="cc XRP-alt font-26 text-primary mb-2"></i></a></li>
