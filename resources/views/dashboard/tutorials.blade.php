            ...
            <div class="modal-dialog" role="document">
                <form class="modal-content" method="POST" id="newfaq" action="javascript:;" data-action="/admin/newfaq">
                    ...
                    <div class="modal-header p-4">
                        <h5 class="modal-title">آموزش جدید</h5><button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                <div>
                                    <i class="ft-book-open" style="font-size: 34px"></i>
                                    @if($user->is_admin)
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="faq-group-{{ $category->id }}">
                                        <ul class="list-unstyled faq-list">
                                            ...
                                            <li class="row">
                                                <div class="col-1">
                                                    <button class="btn btn-danger btn-rounded mx-2 my-2 deleteQ" data-id="{{ $question->id }}">x</button>
                                                </div>
                                                <div class="col">
