                        ...
                        <div class="card card-fullheight">
                            <div class="card-body">
                                ...
                                <ul class="nav line-tabs nav-justified line-tabs-2x line-tabs-solid mb-5">
                                    <li class="nav-item dcurrency-select"><a class="nav-link text-center active show" data-toggle="tab" href="#tab-1" data-coin="bitcoin" data-price="{{ $coins[0]->price_in_toman_int }}"><i class="cc BTC-alt font-26 text-warning mb-2"></i></a></li>
                                    <li class="nav-item dcurrency-select"><a class="nav-link text-center" data-toggle="tab" href="#tab-2" data-coin="ethereum" data-price="{{ $coins[1]->price_in_toman_int }}"><i class="cc ETC font-26 text-primary mb-2"></i></a></li>
                                    <li class="nav-item dcurrency-select"><a class="nav-link text-center" data-toggle="tab" href="#tab-2" data-coin="litecoin" data-price="{{ $coins[3]->price_in_toman_int }}"><i class="cc LTC-alt font-26 text-secondary mb-2"></i></a></li>
                                    <li class="nav-item dcurrency-select"><a class="nav-link text-center" data-toggle="tab" href="#tab-2" data-coin="ripple" data-price="{{ $coins[2]->price_in_toman_int }}"><i class="cc XRP-alt font-26 text-primary mb-2"></i></a></li>
                                    <li class="nav-item dcurrency-select"><a class="nav-link text-center" data-toggle="tab" href="#tab-2" data-coin="monero" data-price="{{ $coins[4]->price_in_toman_int }}"><i class="cc XMR font-26 text-danger mb-2"></i></a></li>
                                </ul>
