    ...
    <div class="content-wrapper">
        ...
        <div class="page-sidebar custom-scroll" id="sidebar">
            ...
            <ul class="sidebar-menu metismenu" id="theulsidebar">
                ...
                <li><a href="/admin/admins"><i class="sidebar-item-icon fas fa-users-cog"></i><span class="nav-label">مدیران و کارشناسان</span></a></li>
                ...
                <li><a href="/admin/offers"><i class="sidebar-item-icon fas fa-exchange-alt"></i><span class="nav-label">پیشنهادات خرید و فروش</span></a></li>
                <li><a href="/admin/transactions"><i class="sidebar-item-icon fas fa-exchange-alt"></i><span class="nav-label">تراکنش‌ها</span></a></li>
                <li><a href="javascript:;"><i class="sidebar-item-icon ft-dollar-sign"></i><span class="nav-label">درخواست‌ها</span><i class="arrow la la-angle-right"></i></a>
                    <ul class="nav-2-level">
                        <li><a href="/admin/cryptopays"><i class="cc sidebar-item-icon BTC-alt"></i><span class="nav-label">برداشت از کیف‌پول ارزی</span></a></li>
                ...
                <li><a href="/admin/alerts"><i class="sidebar-item-icon fas fa-bell"></i><span class="nav-label">اعلان‌ها</span></a></li>
                <li><a href="/admin/faq"><i class="sidebar-item-icon ft-help-circle"></i><span class="nav-label">سوالات متداول</span></a></li>
                <li><a href="/admin/knowledge"><i class="sidebar-item-icon ft-book-open"></i><span class="nav-label">آموزش</span></a></li>
                <li><a href="/admin/settings"><i class="sidebar-item-icon ft-settings"></i><span class="nav-label">تنظیمات</span></a></li>
            </ul>
        </div>
        <!-- END: Sidebar-->
        ...
        <div class="content-area">
            ...
            <nav class="navbar navbar-expand navbar-light fixed-top header">
                ...
                <ul class="navbar-nav">
                    <?php
                    $notifications = \App\Notification::getAdminNotifications();
                    ?>
                    <li class="nav-item dropdown" id="adminnotifcations">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle no-arrow d-inline-flex align-items-center" data-toggle="dropdown" href="#"><span class="d-none d-sm-inline-block mr-2">{{ $user->first_name }} {{ $user->last_name}}</span><span class="position-relative d-inline-block"><img class="rounded-circle" src="/assets/img/users/admin-image.png" alt="image" width="36" /></span></a>
                         <div class="dropdown-menu dropdown-menu-right pt-0 pb-4" style="min-width: 280px;">
                            ...
                            </div><a class="dropdown-item d-flex align-items-center" href="/admin/profile"><i class="ft-user mr-3 font-18 text-muted"></i>اطلاعات کاربری</a><a class="dropdown-item d-flex align-items-center" href="/admin/passchange"><i class="ft-lock mr-3 font-18 text-muted"></i>تغییر رمز عبور</a>
