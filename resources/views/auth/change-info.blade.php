...
<html lang="en">
    ...
    <body data-cache="null">
        ...
        <div class="page-content fade-in-up">
            ...
            <div>
                <div class="card">
                    ...
                    <div class="card-body"> 
                        <form class="pill-steps justified-steps" id="form-wizard-responsive" method="POST" action="/dochange" enctype="multipart/form-data">
                            <h6>مشخصات فردی</h6>
                            <fieldset>
                                @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group-icon input-group-icon-left mb-4">
                                                    ...
                                                    <div class="input-group-icon input-group-icon-left mb-4">
                                                        ...
                                                        @if($user->name !== '')
                                                        <input class="form-control required form-control-solid" required type="text" name="name" readonly value="{{ $user->name }}" title="این فیلد اجباری است." placeholder="نام و نام خانوادگی">
                                                        @else
                                                        <input class="form-control required" required type="text" name="name" readonly value="" title="این فیلد اجباری است." placeholder="نام و نام خانوادگی">
                                                        @endif
                                                    </div>  
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="input-group-icon input-group-icon-left mb-4">
                                                    ...
                                                    <div class="input-group-icon input-group-icon-left mb-4">
                                                        <span class="input-icon input-icon-left"><i class="ft-credit-card"></i></span><input class="form-control required" readonly required title="این فیلد اجباری است." type="digit" value="{{ $user->nationalcode }}"  name="nationalcode" placeholder="شماره کارت ملی">
                                                    </div>  
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 pt-2 px-1  d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="dropzone openfile w-100" id="backdropzone" data-target="#file-back">
                                                ...
                                                <div class="filenames">
                                                    <div class="images">
                                                        <img src='{{ url("/".json_decode($user->files)[0]) }}' style='max-width:150px;margin:10px;'/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 pt-2 px-1  d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="dropzone openfile w-100" id="frontdropzone" data-target="#file-front">
                                                ...
                                                <div class="filenames">
                                                    <div class="images">
                                                        <img src='{{ url("/".json_decode($user->files)[1]) }}' style='max-width:150px;margin:10px;'/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 pt-2 px-1  d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="dropzone openfile w-100" id="selfidropzone" data-target="#file-selfi">
                                                ...
                                                <div class="filenames">
                                                    <div class="images">
                                                        <img src='{{ url("/".json_decode($user->files)[2]) }}' style='max-width:150px;margin:10px;'/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script src="/assets/js/changeinfo.js" type="text/javascript"></script>
